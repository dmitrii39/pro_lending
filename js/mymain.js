$(function () {
    ...
    $('.menu-open, .menu a').click(function () {
        ...
        $('.nav__items').toggleClass('menu-opened');
    });
    ...
    ymaps.ready(init);
        ...
        function init(){ 
            myMap = new ymaps.Map("map", {
                center: [41.3907130824309,2.1978031013613823],
                zoom: 15
            }); 
            
            myPlacemark = new ymaps.Placemark([41.3907130824309,2.1978031013613823], {
                hintContent: 'Наш офис',
                balloonContent: 'Вот наш офис!!!'
            });
